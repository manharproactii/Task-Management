...
class _AddEmployeeScreenState extends State<AddEmployeeScreen> {
  ...
  List<String> roleList = [
    "Sales","Shipping","Planning","Production","Sales","Shipping","Planning","Production","Sales","Shipping","Planning","Production",
    "Sales","Shipping","Planning","Production","Sales","Shipping","Planning","Production","Sales","Shipping","Planning","Production"
  ];
    ...
    return Scaffold(
      body: SafeArea(
        child: Column(
          children: [
            isFlag! ?
            AppbarTitleWidget(title: "Prachi Maheshkumar Patel",)
                :  Row(
                      ...
                      child: Column(
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration: decorationWidget("Email Address",false)
                        ...
                        Container(
                          child: TextFormField(
                            ...
                            decoration:  decorationWidget("Mobile Number",false)
                        ...
                        Container(
                          child: TextFormField(
                              ...
                              decoration:  decorationWidget("Password",true)
                                          ...
                                          Column(
                                            children: [
                                              Padding(
                                                ...
                                                child: Container(height: 4,width: 35,decoration: BoxDecoration(
                        ...
                        Container(
                          child: TextFormField(
                              ...
                              decoration: decorationWidget("Department",true)
                        ...
                        Container(
                          child: TextFormField(
                              ...
                              decoration: decorationWidget("Department Head",true)
                        ...
                        Container(
                          child: TextFormField(
                              ...
                              decoration: decorationWidget("Position",true)
                        ...
                        Container(
                          child: TextFormField(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                jobTypeTextController!.text = "Full-time";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                jobTypeTextController!.text = "Part-time";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                jobTypeTextController!.text = "Work from home";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                              ...
                              decoration: decorationWidget("Job Type",true)
                        ...
                        Container(
                          child: TextFormField(
                              ...
                              decoration: decorationWidget("Joining Date",true)
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                shiftTextController!.text = "1st Shift";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                shiftTextController!.text = "2st Shift";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                shiftTextController!.text = "3rd Shift";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                        ...
                        Container(
                          child: TextFormField(
                                        ...
                                        children: [
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                locationTextController!.text = "Vapi";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                locationTextController!.text = "Valsad";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                                          ...
                                          InkWell(
                                            onTap: (){
                                              setState(() {
                                                Navigator.pop(context);
                                                locationTextController!.text = "Mumbai";
                                              });
                                            },
                                            child: Padding(
                                              padding: const EdgeInsets.only(top: 12.0,bottom: 12.0),
                              ...
                              decoration: decorationWidget("Location",true)
                        ...
                        Padding(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              child: Center(child: Text( isFlag! ? "Save":"Create Employee", style: GoogleFonts.poppins(
                                  textStyle: const TextStyle(
                                      fontSize: 16,
                                      color: Colors.white,
  ...
  decorationWidget(String title,bool showIcon){
    ...
    :Container(width: 0,height: 0,),
        ...
        labelStyle: TextStyle(color:AppColors.blackColor,fontWeight: FontWeight.w600),
  ...
  showIcons(String title){
    if(title == "Password"){
    return  Padding(
        padding: const EdgeInsets.only(top: 20.0,bottom: 0,left: 20,right: 0),
        child: InkWell(
          onTap: (){
            toggleShowCurrentPassword();
          },
    ...
    return  Padding(
        padding: const EdgeInsets.only(top: 15.0,bottom: 0,left: 20,right: 0),
        child: Padding(
          padding: const EdgeInsets.only(top: 6.0,bottom: 6,left: 0,right: 0),
      ...
      return  Padding(
        padding: const EdgeInsets.only(top: 20.0,bottom: 0,left: 25,right: 0),
        child: Padding(
          padding: const EdgeInsets.only(top: 6.0,bottom: 6,left: 6,right: 6),
  ...
  void init() {
    ...
    if(isFlag!){
       nameTextController = TextEditingController(text: "Prachi Maheshkumar Patel");

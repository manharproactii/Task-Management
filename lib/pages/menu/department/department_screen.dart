...
class _DepartmentScreenState extends State<DepartmentScreen> {
  ...
  List<String> departmentList = [
    "IT","Human Resource","Accounting","Sales","Customer Support","IT","Human Resource","Accounting","Sales","Customer Support",
  ];
        ...
        child: Column(
          ...
          Padding(
            ...
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.only(top: 0.0,left: 16,right: 16,bottom: 0),
                child:
                Container(
                  child: TextFormField(
            ...
            Padding(
              ...
              child: Row(children: [
                Expanded(
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      children: [
                      Image.asset('assets/icons/filter.png',fit: BoxFit.contain,height: 12,width: 12),
                      Text('Filter',
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('Filter',
                              style: GoogleFonts.poppins(textStyle: const TextStyle(fontSize: 12,fontWeight: FontWeight.w400,color: AppColors.blackColor))),
                          Image.asset('assets/icons/arrow_down.png',fit: BoxFit.contain,height: 12,width: 12),
                        ],),
                    ),
                  ),
                ),
                ...
                SizedBox(width: 28,),
                Image.asset('assets/icons/dots_horizontal.png',fit: BoxFit.contain,height: 24,width: 24),
              ],),
            ),
            Padding(
              padding: const EdgeInsets.only(top: 16.0,left: 16,right: 16,bottom: 0),
              child: Row(
                ...
                children: [
                  ...
                  Image.asset('assets/icons/un_check_box.png',fit: BoxFit.contain,height: 16,width: 16,),
                  SizedBox(width: 16,),
                  Text('Department Name',
                      style: GoogleFonts.poppins(textStyle: const TextStyle(fontSize: 14,fontWeight: FontWeight.w700,color: AppColors.blackColor))),
                ],
              ),
            ),
            SizedBox(height: 10,),
              ...
              child: SingleChildScrollView(
                child: InkWell(
                  ...
                  child: Padding(
                    ...
                    child: Column(children: departmentList.map((e) {
                      ...
                      return Column(
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Row(
                                  children: [
                                    Image.asset('assets/icons/check_box.png',fit: BoxFit.contain,height: 16,width: 16,),
                                    SizedBox(width: 16,),
                                    Column(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    ...
                                                    child: Image.asset('assets/icons/users.png',fit: BoxFit.contain,height: 15,width: 15,color: AppColors.greyColor5,),
                                                  ),
                                                  SizedBox(width: 3,),
                                                  Text(
                                                      "10",
                                            ...
                                            Container(
                                              child: Row(
                                                ...
                                                children: [
                                                  Padding(
                                                    padding: const EdgeInsets.all(2.0),
                                                    child: Image.asset('assets/icons/task.png',fit: BoxFit.contain,height: 15,width: 15,color: AppColors.greyColor5,),
                                                  ),
                                                  SizedBox(width: 3,),
                                                  Text(
                                                      "15",
                          ...
                          Container(
                            height: 1,width: MediaQuery.of(context).size.width,color: AppColors.lineColor,
                          )
                        ],
                      );
